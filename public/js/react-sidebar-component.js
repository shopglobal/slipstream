...
var LogoButton = React.createClass({displayName: "LogoButton",
	render: function () {
		return 	React.createElement("div", {className: "", onClick:  this.props.handleClick}, 
...
var Sidebar = React.createClass({displayName: "Sidebar",
	render: function () {
		...
		return 	React.createElement("div", {id: "sidebar-wrapper", className:  'col-xs-12 container ' + this.props.show}, 
					React.createElement("ul", {className: "sidebar-nav"}, 
						React.createElement("li", {className: "sidebar-brand"}, 
							React.createElement(LogoButton, {buttonImage:  this.props.buttonImage, handleClick:  this.props.handleButtonClick, buttonImageMini:  this.props.buttonImageMini}), 
